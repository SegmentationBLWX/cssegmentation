'''plop_r101iabnd16_aspp_512x512_vocaug15-5_overlap'''
import os
...
RUNNER_CFG.update({
    ...
    'work_dir': 'plop_r101iabnd16_aspp_512x512_vocaug15-5_overlap',
    'logfilepath': 'plop_r101iabnd16_aspp_512x512_vocaug15-5_overlap/plop_r101iabnd16_aspp_512x512_vocaug15-5_overlap.log',
})